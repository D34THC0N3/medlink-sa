...
export const PHARMACY_ORDERS = [
  { id: "o1", patient: "Thandiwe M.", medicine: "Glucophage 850mg × 60", price: 89.99, status: "new", delivery: true, address: "Rosebank, JHB" },
  { id: "o2", patient: "Sipho D.", medicine: "Augmentin 875mg × 14", price: 189.99, status: "preparing", delivery: true, address: "Sandton, JHB" },
  { id: "o3", patient: "Aisha P.", medicine: "Ventolin Inhaler", price: 129.99, status: "ready", delivery: false, address: "In-store pickup" },
  { id: "o4", patient: "Johan V.", medicine: "Brufen 400mg × 20", price: 39.99, status: "new", delivery: true, address: "Parktown, JHB" },
  { id: "o5", patient: "Walk-in", medicine: "Panado 500mg × 24", price: 24.99, status: "completed", delivery: false, address: "In-store" },
];

export const PHARMACY_INVENTORY = [
  { id: "i1", name: "Panado 500mg", stock: 240, reorder: 50, status: "ok" },
  { id: "i2", name: "Augmentin 875mg", stock: 18, reorder: 30, status: "low" },
  { id: "i3", name: "Glucophage 850mg", stock: 92, reorder: 40, status: "ok" },
  { id: "i4", name: "Ventolin Inhaler", stock: 7, reorder: 15, status: "critical" },
  { id: "i5", name: "Allergex 4mg", stock: 130, reorder: 40, status: "ok" },
  { id: "i6", name: "Brufen 400mg", stock: 22, reorder: 30, status: "low" },
];
