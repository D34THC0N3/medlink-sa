...
export default function Page() {
  const { user } = useAuth();
  // Gated on mounted to avoid hydration mismatch (user is null on server,
  // populated from localStorage on client).
  ...
  return (
    <>
      ...
      <main className="relative">
        ...
        {/* Landing strip — appears after hero scrolls away */}
        <div className="relative">
          ...
          {/* FAQ section — 3 questions, rest on /faq */}
          <FaqSection />
